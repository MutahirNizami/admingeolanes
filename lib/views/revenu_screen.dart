              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 4),
                    Text("Tours",
                        style: TextStyle(color: Mycolor().exportbordercolor)),
                    SizedBox(width: 16),
                ...
                LineChartData(
                  ...
                  gridData: FlGridData(
                    ...
                    getDrawingHorizontalLine: (value) => FlLine(
                        color: Mycolor().fieldbordercolor, strokeWidth: 1),
                    ...
                    bottomTitles: AxisTitles(
                      sideTitles: SideTitles(
                        ...
                        getTitlesWidget: (value, meta) {
                          ...
                          return Padding(
                            padding:
                                EdgeInsets.symmetric(horizontal: width * 0.5),
                            child: Text(
                  ...
                  borderData: FlBorderData(
                    ...
                    border: Border(
                      left:
                          BorderSide(color: Mycolor().subtitlecolor, width: 1),
                      bottom:
                          BorderSide(color: Mycolor().subtitlecolor, width: 1),
                    ),
                  ),
